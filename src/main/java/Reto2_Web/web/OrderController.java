...
public class OrderController {
    ...
    public List<Order> getOrdersSalesManByDate(@PathVariable("date") String dateStr, @PathVariable("id") int id){
        return orderService.findOrdersSalesManByDate(ParseFecha(dateStr), id);
    }
